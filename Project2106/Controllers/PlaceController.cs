...
public class PlaceController : Controller
{
        ...
        int page = 1)
    {
        ...
        var previewImageUrl = await _db.PostMedia
            .AsNoTracking()
            .Where(m =>
                m.Post != null &&
                m.Post.PlaceId == id &&
        ...
        var currentUserIsAuthenticated =
            ControllerContext?.HttpContext?.User?.Identity?.IsAuthenticated == true;
        ...
        var model = new PlaceDetailsViewModel
        {
            ...
            PreviewImageUrl = string.IsNullOrWhiteSpace(previewImageUrl)
                ? null
                : previewImageUrl
        };
