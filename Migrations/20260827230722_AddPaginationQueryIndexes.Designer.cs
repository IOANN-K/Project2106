...
namespace PROJECT2106.Migrations
{
    ...
    [Migration("20260827230722_AddPaginationQueryIndexes")]
    partial class AddPaginationQueryIndexes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PROJECT2106.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("Notifications", t =>
                        {
                            t.HasCheckConstraint("CK_Notifications_Type_Range", "\"Type\" >= 0 AND \"Type\" <= 3");
                        });
                });
            ...
            modelBuilder.Entity("PROJECT2106.Models.Notification", b =>
                {
                    b.HasOne("PROJECT2106.Models.AppUser", "ActorUser")
                        .WithMany()
